...
1. remove `CleanWebpackPlugin` from the plugins array in `/internals/webpack/webpack.config.prod.js`
2. remove `CleanWebpackPlugin` as a requirement at the top of `/internals/webpack/webpack.config.prod.js`
